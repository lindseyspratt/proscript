...
test_bootstrap.js:	wam_compiler.pl testing.pl wam_bootstrap.pl bootstrap_js.pl tests.pl simple_test.pl console_button_test.pl debugger.pl bench/nand.pl bench/common.pl bench/hook.pl
		$(SWIPL) -q -f wam_compiler.pl -g "build_saved_state(['bench/nand.pl', 'bench/common.pl', 'bench/hook.pl', 'simple_test.pl', 'console_button_test.pl', 'debugger.pl', 'wam_compiler.pl', 'bootstrap_js.pl', 'demo.pl'], 'foo'), halt"
