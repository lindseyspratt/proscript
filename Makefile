...
bootstrap.js:	wam_compiler.pl testing.pl wam_bootstrap.pl bootstrap_js.pl demo.pl tests.pl simple_test.pl console_button_test.pl
		$(SWIPL) -q -f wam_compiler.pl -g "build_saved_state(['simple_test.pl', 'console_button_test.pl', 'wam_compiler.pl', 'bootstrap_js.pl', 'demo.pl'], foo), halt"
