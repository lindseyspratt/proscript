...
wam-pp.js:	foreign.js memory_files.js wam.js read.js record.js fli.js stream.js gc.js dom.js dom_element_property.js dom_element_method.js debugger.js decode_instruction.js promise.js
		$(SWIPL) -q -f js_preprocess.pl -g "preprocess(['foreign.js', 'memory_files.js', 'wam.js', 'read.js', 'record.js', 'fli.js', 'stream.js', 'gc.js', 'dom.js', 'dom_element_property.js', 'dom_element_method.js', 'debugger.js', 'decode_instruction.js', 'promise.js'], 'wam-pp.js', [debug=$(DEBUG)]), halt"
