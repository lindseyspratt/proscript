...
% Lindsey Spratt, March 12, 2019: Handling of cut for a clause is broken. interpret((foo, !)) does not
% prevent the interpret(p, _) :- define(p, (foo,!)), interpret((foo,!)). clause from
% finding another solution for 'p' such as define(p, (bar)).
